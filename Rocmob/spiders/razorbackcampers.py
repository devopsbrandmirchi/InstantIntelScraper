...
class RazorbackcampersSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for i in units:
            ...
            for UnitId in all_ids:
                url = 'https://www.razorbackcampersales.com/product/used-2024-forest-river-rv-salem-fsx-164rble-{}-29'.format(UnitId)
                yield Request(url, callback=self.parse_next, meta={'list_url': 'https://www.razorbackcampersales.com/rv-search', 'UnitId': UnitId}, dont_filter=True)
        try:
    ...
    def parse_next(self, response):
        ...
        url = 'https://www.razorbackcampersales.com' + title_link if title_link else response.url
