...
class CampingworldFresnoSpider(scrapy.Spider):
    name = "campingworldareaFAR"
    allowed_domains = ["campingworld.com", "algolianet.com"]
    inventory_url = "https://rv.campingworld.com/shop-rvs?indexName=rvcw-inventory_recommended&glCode=fre"
            ...
            "requests": [
                {
                    ...
                    "params": "query=&hitsPerPage=20&page={}&facetFilters=[[\"glCode:fre\"]]".format(page)
                }
            ]
        }
        return JsonRequest(
    ...
    def parse_next(self, raw_json_text):
        try:
            ...
            for item in hits:
                dealership_name = 'Camping World, Fresno'
                dealer_type = 'RV'
                cms = ''
