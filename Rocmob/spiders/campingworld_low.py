...
class CampingworldLowSpider(scrapy.Spider):
    name = "campingworldareaLOW"
    allowed_domains = ["campingworld.com", "algolianet.com"]
    inventory_url = "https://rv.campingworld.com/shop-rvs?indexName=rvcw-inventory_recommended&glCode=low"
            ...
            "requests": [
                {
                    ...
                    "params": "query=&hitsPerPage=20&page={}&facetFilters=[[\"glCode:low\"]]".format(page)
                }
            ]
        }
        return JsonRequest(
    ...
    def parse_next(self, raw_json_text):
        try:
            ...
            for item in hits:
                dealership_name = 'Camping World (Lowell, AR)'
                dealer_type = 'RV'
                cms = ''
