...
class FuntownrvSpider(scrapy.Spider):
    name = "funtownrvLR"

    headers = {
        "User-Agent": "rogerbot",
        "Referer": "https://www.funtownrv.com/"
    }

    inventory_urls = {
        "Inventory": "https://www.funtownrv.com/rv-search?s=true&lots=1958&pagesize=12"
    }
        ...
        try:
            ...
            for node in nodes:
                ...
                if url and 'https' not in url:
                    url = 'https://www.funtownrv.com' + url
                    yield scrapy.Request(
                        url=url,
    ...
    def parse_detail(self, response):
        ...
        dealership_name = 'Fun Town RV Little Rock'
        dealer_type = 'RV'
        dealership_address = ''
        store_code = ''
        dealer_url = 'https://www.funtownrv.com/'
        cms = 'Interact RV'
